...
import { BioHeroScene } from './components/BioScene';
import { AsmPhasingDemo, N50Chart, WorkflowDiagram } from './components/ProjectDiagrams';
import { ArrowDown, Menu, X, FileText, Github, Linkedin, Download } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F9F8] text-stone-800 selection:bg-[#007D69] selection:text-white">
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <div className="flex justify-center mt-16">
             <a href="#resources" onClick={scrollToSection('resources')} className="group flex flex-col items-center gap-2 text-sm font-medium text-stone-400 hover:text-[#007D69] transition-colors cursor-pointer animate-bounce">
                <span>SCROLL</span>
      ...
      <main>
        {/* Resources Section */}
        <section id="resources" className="py-20 bg-[#F5F9F8] border-b border-stone-200">
           <div className="container mx-auto px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                 {/* Card 1: Interim */}
                 <div className="bg-white p-6 rounded-xl border border-stone-200 hover:border-[#007D69] transition-all group cursor-pointer shadow-sm hover:shadow-md">
                    <div className="flex items-start justify-between mb-4">
                       <div className="p-3 bg-stone-100 rounded-lg group-hover:bg-[#007D69]/10 transition-colors">
                          <FileText className="text-stone-600 group-hover:text-[#007D69]" size={24} />
                       </div>
                       <Download className="text-stone-300 group-hover:text-[#007D69]" size={20} />
                    </div>
                    <h3 className="font-bold text-stone-900 mb-1 font-serif">Interim Report</h3>
                    <p className="text-xs text-stone-500 mb-4">Phase 1 progress and initial benchmarks.</p>
                    <div className="text-[10px] font-mono text-stone-400">PDF • 2.4 MB</div>
                 </div>
                 {/* Card 2: Final Report */}
                 <div className="bg-white p-6 rounded-xl border border-stone-200 hover:border-[#007D69] transition-all group cursor-pointer shadow-sm hover:shadow-md">
                    <div className="flex items-start justify-between mb-4">
                    ...
                    <p className="text-xs text-stone-500 mb-4">Complete methodology and results analysis.</p>
                    <div className="text-[10px] font-mono text-stone-400">PDF • 15.1 MB</div>
                 </div>
                 {/* Card 3: Detailed Proposal */}
                 <div className="bg-white p-6 rounded-xl border border-stone-200 hover:border-[#007D69] transition-all group cursor-pointer shadow-sm hover:shadow-md">
                    <div className="flex items-start justify-between mb-4">
                       <div className="p-3 bg-stone-100 rounded-lg group-hover:bg-[#007D69]/10 transition-colors">
                          <FileText className="text-stone-600 group-hover:text-[#007D69]" size={24} />
                    ...
                    <p className="text-xs text-stone-500 mb-4">Original project scope and timeline.</p>
                    <div className="text-[10px] font-mono text-stone-400">PDF • 1.2 MB</div>
                 </div>
              </div>
           </div>
        </section>
        ...
        {/* Results */}
        <section id="results" className="py-24 bg-stone-900 text-stone-100">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <div className="lg:col-span-5">
                         <div className="inline-flex items-center gap-2 px-3 py-1 bg-stone-800 text-[#C5A059] text-xs font-bold tracking-widest uppercase rounded-full mb-6 border border-stone-700">
                            Preliminary Results
                        </div>
                        <h2 className="font-serif text-4xl md:text-5xl mb-6 text-white">Bridging the Gap</h2>
                        ...
                        <ul className="space-y-4 text-stone-300">
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-2 h-2 rounded-full bg-[#C5A059]"></div>
        ...
        <section className="py-24 bg-white">
             <div className="container mx-auto px-6 max-w-4xl text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                     <div className="p-6 bg-[#F5F9F8] rounded-lg border border-stone-200">
                     ...
                     <div className="p-6 bg-white rounded-lg border border-stone-200 dashed-border">
        ...
        <section id="team" className="py-24 bg-[#F5F9F8] border-t border-stone-300">
           <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch flex-wrap">
                    <div className="flex flex-col items-center p-8 bg-white rounded-xl border border-stone-200 shadow-sm w-full max-w-xs">
                         ...
                         <p className="text-sm text-stone-600 text-center">Dept of Computer Science<br/>The University of Hong Kong</p>
                    </div>

                    <div className="flex flex-col items-center p-8 bg-white rounded-xl border border-stone-200 shadow-sm w-full max-w-xs opacity-80">
                         <div className="w-20 h-20 rounded-full bg-stone-100 mb-4 overflow-hidden border-2 border-dashed border-stone-300"></div>
